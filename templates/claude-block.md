...
**Effort level does NOT change this. Even at high/max effort, delegate implementation — the quality comes from your tests, audit, and review, not from typing every line yourself.**
...
If the task matches any row above: write the tests + context, call `ds_dispatch`. Do NOT read source files or start implementing. Delegation IS the thorough approach — your effort should go into test quality, specification clarity, and diff review, not typing implementation code.
